...
sigma = 1.0/2000*[10 15 25 37 51 66 82 100 ;
...
for block_i=1:8:N
    for block_j=1:8:M
        ...
        %D(block_i:block_i+7, block_j:block_j+7)=DCT_block;
        F2(block_i:block_i+7, block_j:block_j+7)=TDCT_without_DCT_call(DCT_block,x,x);
